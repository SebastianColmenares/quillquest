...
export default function BookCard({ title, description, authorName, dateCreated, genres, className }) {
  return (
    <div className={`flex items-center justify-center m-2 ${className}`}>
