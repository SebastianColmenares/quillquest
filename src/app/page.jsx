            ...
            <main className='flex flex-col items-center justify-center'>
                ...
                <div className="text-gray-800 text-2xl flex justify-center mt-4 w-10/12">
                  <section className="p-10 grid grid-cols-5 grid-rows-2 gap-[1.5px] w-full">
                      ...
                      <div className="p-10 bg-blue-400 flex flex-col gap-1 col col-span-4 row-span-1 hover:bg-blue-500 transition duration-400">
                          <Link href="/biblioteca">BIBLIOTECA</Link>
                          <p className="text-sm">Navega por nuestra biblioteca, donde quizas encuentres la historia que buscas.</p>
                      </div>
                      <div className="p-10 bg-blue-400 flex flex-col gap-1 col col-span-2 row-span-1 hover:bg-blue-500 transition duration-400">
                      ...
                      <button className="p-10 bg-blue-400 flex flex-col gap-1 col col-span-2 row-span-1 hover:bg-blue-500 transition duration-400">
